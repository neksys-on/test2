        ...
        <div className={styles.popup_body}>
          <div className={styles.div_block}>
            <div className={styles.div_input}>
              ...
              <input id={'input_surname'} className={styles.popup_input} type='text'
              onFocus={()=>{
            ...
            <div className={styles.div_input}>
              ...
              <input id={'input_name'} className={styles.popup_input} type='text'
              onFocus={()=>{
                highlighting('name')
              }}
              onBlur={()=>{
          ...
          <div className={styles.div_block}>
            <div className={styles.div_input}>
              ...
              <input id={'input_patronymic'} className={styles.popup_input} type='text'
              onFocus={()=>{
          ...
          <div className={styles.div_block}>
            ...
            <div className={styles.div_input}>
              ...
              <input id={'input_city'} className={styles.popup_input} type='text'
              onFocus={()=>{
                highlighting('city')
              }}
              onBlur={()=>{
          ...
          <div className={styles.div_block}>
            <div className={styles.div_input}>
              ...
              <input id={'input_address'} className={styles.popup_input} type='text'
              onFocus={()=>{
