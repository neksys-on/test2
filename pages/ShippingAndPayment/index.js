      ...
      <div style={{
        ...
        <div className={styles.div_main}>
          ...
          <div className={styles.div_text}>
            ...
            <h4>1. Оплата с Yoomoney или с банковской карты через сайт.</h4>
            <h4>2. Оплата вручную, переводом на карту Сбербанка по номеру телефона <a href="tel:+79147730000">+79147730000</a>, получатель Ольга Дмитриевна К.</h4>
            <h4>3. Оплата вручную, переводом на QIWI <a href="tel:+79147730000">+79147730000</a></h4>
          </div>
        </div>
      </div>
    </Layout>
